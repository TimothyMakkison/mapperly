...
public class DerivedTypeTest
{
    ...
    public Task WithInterfaceShouldWork()
    {
        var source = TestSourceBuilder.MapperWithBodyAndTypes(
            """
            [MapDerivedType(typeof(AImpl1), typeof(BImpl1))]
            [MapDerivedType(typeof(AImpl2), typeof(BImpl2))]
            public partial B Map(A src);
            """,
    ...
    public Task WithObjectShouldWork()
    {
        var source = TestSourceBuilder.MapperWithBody(
            ...
            [MapDerivedType(typeof(IEnumerable<string>), typeof(IEnumerable<int>))]
    ...
    public void DuplicatedSourceTypeShouldDiagnostic()
    {
        var source = TestSourceBuilder.MapperWithBodyAndTypes(
            """
            [MapDerivedType(typeof(AImpl1), typeof(BImpl1))]
            [MapDerivedType(typeof(AImpl1), typeof(BImpl2))]
            public partial B Map(A src);
            """,
            "interface A {}",
            "interface B {}",
        ...
        TestHelper
            ...
            .Should()
            .HaveDiagnostic(
                new DiagnosticMatcher(DiagnosticDescriptors.DerivedSourceTypeDuplicated, "Derived source type AImpl1 is duplicated")
            );
    }
    ...
    public void NotMappableShouldDiagnostic()
    {
        var source = TestSourceBuilder.MapperWithBody(
            """
            [MapDerivedType(typeof(Version), typeof(int))]
            public partial object Map(object src);
            """
        );
        TestHelper
